-- Esta migração marca como aplicadas as migrações problemáticas
-- para que possamos pular elas e aplicar nossas correções

-- Inserir as migrações problemáticas na tabela de controle
INSERT INTO supabase_migrations.schema_migrations (version, statements, name)
VALUES 
('20240304', ARRAY['-- Migração marcada como aplicada para evitar problemas'], '20240304_fix_competition_policies.sql')
...
ALTER TABLE IF EXISTS community_organizers DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS community_organizers ENABLE ROW LEVEL SECURITY;
